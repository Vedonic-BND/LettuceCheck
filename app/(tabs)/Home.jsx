...
const Home = () => {
	...
	useEffect(() => {
		...
		db.transaction((tx) => {
			tx.executeSql(
				"CREATE TABLE IF NOT EXISTS history (id INTEGER PRIMARY KEY AUTOINCREMENT, date DATETIME NOT NULL, image TEXT NOT NULL, accuracy REAL NOT NULL, prediction VARCHAR(11) NOT NULL);",
				[],
				(_, resultSet) => {
					console.log("Table created or exists:", resultSet);
				},
				(_, error) => {
